...
x_test, x_val, y_test, y_val = train_test_split(x_temp, y_temp, test_size=0.5, shuffle=True, random_state=seed)
...
hidden_layer1 = Dense(25, activation='sigmoid')(input_layer)
hidden_layer1 = tf.keras.layers.Dropout(0.2)(hidden_layer1)
hidden_layer2 = Dense(10, activation='sigmoid')(hidden_layer1)
h2 = tf.keras.layers.Dropout(0.1)(hidden_layer2)
h2 = Dense(10, activation='sigmoid')(h2)
output_layer = Dense(2, activation='sigmoid')(h2)
...
# Entrenamiento
history = model.fit(x_train_scaled, y_train, epochs=70, class_weight=d,
